...
<body class="font-inter antialiased bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-4">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="mt-8 text-center">
                <a href="{{ route('booking.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                    ← Back to Website
                </a>
            </div>
        </div>
